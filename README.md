...
*Supuestos del código*:
	...
	- Para esta solución en typescript me base en mi código de python y fui paso a paso transformándolo a partir de lo que leía de la documentación oficial de Typescript
		- EJ: Para los resultados use un terniario en python y tuve que buscar esa lógica para typescript  lo que se ve en la línea 65 del archivo `main.ts`
	- Para typescript copie los interface `TestData` y `TestCase` para crear un equivalente para el ejercicio bonus y presentarlo después del original durante la ejecución
